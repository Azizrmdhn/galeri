...
<body>
    ...
    <div class="container mx-auto px-10">
            <div class="w-full max-w-10xl rounded  bg-white shadow-xl p-10 lg:p-20 mx-auto text-gray-800 relative md:text-left">
                <div class="md:flex items-center -mx-10">
                    <div class="w-full md:w-1/2 px-10 mb-10 md:mb-0">
                        <div class="relative">
                            <a href="{{ route('detailImage.unduh',$dataImage->lokasiFile) }}" target="_blank" class="z-10 absolute px-5 bg-lime-500 text-white rounded-full py-2 mb-10 m-5 hover:bg-lime shadow-md">Unduh Gambar</a>
            ...
            <h1 class="font-bold text-3xl text-lime-500 ">Komentar </h1>
            @guest
            <div class="flex items-center bg-lime-500 text-white text-sm font-bold px-4 py-3 rounded-lg" role="alert">
            ...
            <section class="flex justify-center py-5 gap-5 antialiased">
                ...
                <div class="flex justify-center items-center">
                    <script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script><lottie-player src="https://lottie.host/a6482740-adf0-4c16-a197-b936d3c83858/4BpZB8jEGv.json" background="##ffffff" speed="1" style="width: 200px;" loop  autoplay direction="1" mode="normal"></lottie-player>
                    <div class="w-80 text-1xl"><span class="text-lime-500">Belum ada komentar!</span>
                        @auth
